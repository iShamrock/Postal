...
public class FileImageUpload {
     ...
     * @return 返回响应的内容
     */
    public  String uploadFile(File file,String RequestURL,String userPhone) {
        String PREFIX="/";
        String LINE_END="\n";
        ...
        try {
            ...
            if(file!=null) {
                 ...
                 */
                sb.append("Content-Disposition: form-data; phone=\""+userPhone+"\"; name=\"img\"; filename=\""+file.getName()+"\""+LINE_END);
                sb.append("Content-Type: application/octet-stream; charset="+CHARSET+LINE_END);
                sb.append(LINE_END);


                String filediscribe=sb.toString();
                filediscribe.indexOf("filename=");
